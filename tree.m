...
%OUTPUTS:
%tree_acc: accuracy for each fold
%tree_acc_avg: mean cross-validation accuracy
% predicted_y_avg: cross_validation model predictions
%tree_vperf: lowest validation performance, averaged across folds
...
for k=1:5
    tree=fitctree(train_inx{1,k}, targets_inx{1,k},...
        'MaxNumSplits',params.MaxNumSplits, 'MinLeafSize', params.MinLeafSize, 'MaxNumCategories', params.MaxNumCategories,  ...
