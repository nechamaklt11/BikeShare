...
%%
tree_best_params=grid_search('MinLeafSize',[1 2 3 4 5], 'MaxNumSplits',[10 25 50 100 150], 'MaxNumCategories', [ 2 5 8 10 20], 'data4analysis',tree_params,3);
%%
svm_best_params=grid_search('PassLimit', [1 5 10], 'LearnRate',[0.001 0.01 0.1 0.5 1] ,'Lambda',[0.0005 0.005 0.05 0.5] ,'data4analysis',svm_params,4);
%%
